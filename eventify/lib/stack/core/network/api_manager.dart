  ...
  Future<ApiResult<TOutput>> call<TOutput extends Object>(
    ...
    try {
      ...
      if (api.responseMapper == null && _isSuccessful(response)) {
        if (TOutput == bool) return ApiResult.success(value: true as TOutput);
        if (TOutput == String) return ApiResult.success(value: response.data);
      ...
      if (cancelToken != null) cancelToken.refresh();
